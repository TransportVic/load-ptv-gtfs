...
export default class GTFSStopsReader extends GTFSReader {
  ...
  constructor(file, suburbData, suburbHook) {
    super(file)
    this.#suburbData = suburbData
    this.#suburbHook = suburbHook
  }

  getSuburbData() {
    return this.#suburbData
  }

  getSuburbHook() {
    return this.#suburbHook
  }
  ...
  processEntity(data) {
    ...
    return GTFSStop.create(stopData, this.getSuburbData(), this.getSuburbHook())
  }
}