...
export default class GTFSRoute {
  ...
  static create(data, mode) {
    ...
    let routeTypes = [ MetroGTFSRoute, NewGTFSRoute, SmartrakGTFSRoute, GTFSRoute ]
 ...
 */
class MetroGTFSRoute extends NewGTFSRoute {
  ...
  static canProcess(routeGTFSID, mode) {
    return super.canProcess(routeGTFSID, mode) && mode === TRANSIT_MODES.metroTrain
  }
