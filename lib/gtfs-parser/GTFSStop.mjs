...
export class GTFSStop {
  ...
  constructor({ stopGTFSID, stopName, stopLat, stopLon, locationType, parentStopGTFSID }, suburbs) {
    this.stopGTFSID = stopGTFSID
    this.originalName = stopName.replace(/ \(\w+\.\.\. #/, ' #').replace(/  +/g, ' ').trim()

    this.locationType = locationType
    this.parentStopGTFSID = parentStopGTFSID
...
export class GTFSRRBStop extends GTFSPlatformStop {
  ...
  static canProcess(data) {
    return super.canProcess(data) && data.platform === 'R-Bus'
  }
