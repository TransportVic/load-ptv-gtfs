...
export default class RouteLoader {
   ...
   * @param {string} collectionName The collection to store the routes in. Defaults to gtfs-routes
   */
  constructor(routesFile, agencyFile, mode, database, collectionName = 'gtfs-routes') {
    this.#routes = database.getCollection(collectionName)
    this.#mode = mode
    this.#routesReader = this.createRouteReader(routesFile, mode)
